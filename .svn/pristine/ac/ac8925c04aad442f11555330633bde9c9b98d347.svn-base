...
public class DesignationControllor {
	...
	@GetMapping(value = "/getById/{designationId}/{moduleId}", produces = { MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<?> getById(@PathVariable("designationId") Long designationId,@PathVariable(value = "moduleId", required = true) Long moduleId) {
