...
@ComponentScan(basePackages = { "com.sterp.multitenant.tenant.*" })
@Order(1)
@EnableJpaRepositories(basePackages = {
		"com.sterp.multitenant.tenant.*" }, entityManagerFactoryRef = "tenantEntityManagerFactory", transactionManagerRef = "tenantTransactionManager")
...
public class TenantDatabaseConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(
		...
		emfBean.setPackagesToScan("com.sterp.multitenant.tenant.*");
