package com.sterp.multitenant.mastertenant.config;
...
@EnableJpaRepositories(basePackages = {
		"com.sterp.multitenant.mastertenant.*" }, entityManagerFactoryRef = "masterEntityManagerFactory", transactionManagerRef = "masterTransactionManager")
